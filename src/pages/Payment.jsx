              ...
              {methods.map((method) => (
                ...
                >
                  ...
                  <div className="flex flex-col items-start">
                    <span className="font-bold text-sm text-light-blue-dark">
                      {method.label}
                    </span>
                    {width <= 768 && (
                      <p className="font-normal text-sm text-light-blue-dark">
                        Wallet, Debit card, Credit card, Net Banking, UPI Pay
                        using Paypal wallet and win upto Rs 250 on minimum order
                        value of Rs 500
                      </p>
                    )}
                  </div>
